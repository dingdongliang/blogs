...
(function (h) {
    ...
    var m = function (a) {
        ...
        $b = RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)",
            "g"), Wa = /[',$Â£â‚¬Â¥%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, L = function (a) {
            return !a || !0 === a || "-" === a ? !0 : !1
        }, Nb = function (a) {
            var b = parseInt(a, 10);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "从第 _START_ 条到第 _END_ 条,共 _TOTAL_ 条",
            sInfoEmpty: "从第 0 条到第 0 条,共 0 条",
    ...
    m.ext = x = {
        buttons: {},
        classes: {},
        build: "bs4/dt-1.10.16/cr-1.4.1/fc-3.2.3/fh-3.1.3/r-2.2.0/rg-1.0.2/rr-1.2.3/sc-1.4.3/sl-1.2.3",
        errMode: "alert",
        feature: [],
        search: [],
    ...
    d.extend(m.prototype, {
        fnUpdate: function () {
            ...
            var c = d(this.s.dt.nTable.parentNode).outerHeight(),
                e = d(this.s.dt.nTable.parentNode.parentNode).outerHeight(), f = this._fnDTOverflow(),
                g = this.s.iLeftWidth, h = this.s.iRightWidth, i = "rtl" === d(this.dom.body).css("direction"),
                k = function (b, c) {
...
(function (c) {
    ...
    var n = c.fn.dataTable, h = function (b, a) {
    ...
    c.extend(h.prototype, {
        _constructor: function () {
            var b = this, a = this.s.dt, d = a.settings()[0], e = c(k).width();
            ...
            var b = this, a = this.c.breakpoints,
                d = this.s.dt, e = d.columns().eq(0).map(function (a) {
            ...
            e.each(function (b, e) {
                for (var d = b.className.split(" "), f = !1, h = 0, k = d.length; h < k; h++) {
                    ...
                    c.each(a, function (a, b) {
                        var c = b.name.split("-"), d = j.match(RegExp("(min\\-|max\\-|not\\-)?(" +
                            c[0] + ")(\\-[_a-zA-Z0-9])?"));
            ...
            var b = this, a = this.s.dt, d = c(k).width(), e = this.c.breakpoints, f = e[0].name, g = this.s.columns, i,
                h = this.s.current.slice();
            ...
            e = !1;
            i = 0;
            for (d = g.length; i < d; i++) if (!1 === j[i] && !g[i].never && !g[i].control) {
                e = !0;
                break
            }
            ...
            var b = this.s.dt, a = this.s.columns;
    ...
    h.defaults = {
        ...
        auto: !0,
        details: {display: h.display.childRow, renderer: h.renderer.listHidden(), target: 0, type: "inline"},
        orthogonal: "display"
    };
...
(function (e) {
    ...
    function z(a, c, b, d) {
        var f = a[c + "s"]({search: "applied"}).indexes(), d = e.inArray(d, f), l = e.inArray(b, f);
    ...
    g.select.init =
        function (a) {
            var c = a.settings()[0], b = c.oInit.select, d = g.defaults.select, b = b === h ? d : b, d = "row",
                f = "api", l = !1, w = !0, k = "td, th", j = "selected", i = !1;
            c._select = {};
            if (!0 === b) f = "os", i = !0; else if ("string" === typeof b) f = b, i = !0; else if (e.isPlainObject(b) && (b.blurable !== h && (l = b.blurable), b.info !== h && (w = b.info), b.items !== h && (d = b.items), b.style !== h && (f = b.style, i = !0), b.selector !== h && (k = b.selector), b.className !== h)) j = b.className;
            a.select.selector(k);
            a.select.items(d);
            a.select.style(f);
            a.select.blurable(l);
                ...
                b.on("preXhr.dt.dtSelect",
                    function () {
                        var c = b.rows({selected: !0}).ids(!0).filter(function (b) {
                            return b !== h
                        }), a = b.cells({selected: !0}).eq(0).map(function (c) {
    ...
    o("columns().deselect()", "column().deselect()", function () {
        ...
        this.iterator("column", function (c, b) {
            ...
            var a = new g.Api(c), f = a.column(b);
            ...
            a.cells(null, b).indexes().each(function (b) {
                var a = c.aoData[b.row], d = a._selected_cells;
